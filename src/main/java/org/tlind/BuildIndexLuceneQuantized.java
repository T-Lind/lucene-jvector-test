...
public class BuildIndexLuceneQuantized {
    ...
    private static final int numberOfVectorsToIndex = 500_000; // TODO: SET THIS BASED ON THE SIZE OF YOUR DATASET!
    ...
    public static void main(String[] args) throws Exception {
        ...
        float indexLatency = loadDatasetAndIndex(writer, txtFilePath,
                Runtime.getRuntime().availableProcessors(), numberOfVectorsToIndex); // Change this to the number of entries to be placed in the index
